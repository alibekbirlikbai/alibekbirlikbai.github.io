                ...
                return (
                    <div className='content__block-description'>
                        <p className='content__block-quote'>
                            <blockquote>
                                <span className='quote-title'>Note:</span> Для подключения к <b>Google Drive</b> нужно сгенерировать токен (<b>service-account-auth.json</b>) с permissions в <b>Google Cloud Console</b>
                            </blockquote>
                        </p>
